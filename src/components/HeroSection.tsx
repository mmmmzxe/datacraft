...
export default function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex items-center bg-[#11113F] overflow-hidden px-6 py-30 lg:py-0">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(rgba(133,236,252,0.3) 1px, transparent 1px), linear-gradient(90deg, rgba(133,236,252,0.3) 1px, transparent 1px)",
      ...
      <div className="relative max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col items-start text-left">
          ...
          <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-md border border-[#85ECFC]/20 rounded-full px-5 py-2 mb-8 animate-fade-in">
            ...
            <span className="text-xs font-bold uppercase tracking-widest text-[#85ECFC]">
              Professional Data Training · 2025
            </span>
          </div>

          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white leading-none mb-8">
            Build the <br />
            <span className="bg-linear-to-r from-[#85ECFC] to-[#5A4DE5] bg-clip-text text-transparent">
              Infrastructure
            </span>{" "}
            <br />
            of Tomorrow
          ...
          <p className="text-white/60 text-lg md:text-xl max-w-xl leading-relaxed mb-10">
            A specialized academy designed to transform enthusiasts into
            world-class{" "}
            <span className="text-white font-bold">Data Engineers</span> through
