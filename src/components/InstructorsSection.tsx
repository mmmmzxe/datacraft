...
const instructors: {
...
}[] = [
  {
    ...
    image: Abdo,
    linkedin:
      "https://www.linkedin.com/in/abdelrahman-ahmed11?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
    courses: 5,
    students: 1200,
  },
  {
    id: 2,
    name: "Hosni Mohamed",
    role: "Senior Data Engineer & Instructor",
    bio: [
    ...
    image: Hosni,
    linkedin:
      "https://www.linkedin.com/in/hosniadel?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
    courses: 3,
    students: 750,
  },
  {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-[#11113F]/50 text-base max-w-2xl mx-auto">
            Our instructors are experienced data engineers and technologists who
            bring real-world expertise into every lesson. A small, dedicated
            team of 2-10 professionals passionate about data engineering
            education.
          </p>
        </div>
              ...
              <div className="p-5">
                ...
                <div className="flex items-center gap-4 pt-3 border-t border-gray-100">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-xs text-[#11113F]/50">
